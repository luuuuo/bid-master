...
contract BlindAuction is AuctionEvents, AuctionErrors{
    ...
    function reveal(
        ...
        //     console2.log("=======fake===========", fake);
        //     console2.logString(secret);
        //     console2.logBytes32(bids[msg.sender][i].blindedBid);
        //     console2.log("=======bids[msg.sender].length===========", bids[msg.sender].length);
        ...
        console2.log("=======lastHighestBid===========", lastHighestBid);
